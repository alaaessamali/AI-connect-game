...
start_button = tk.Button(window, text="Start Alphabeta",
                         command=lambda: start_game_with_alpha(get_depth(difficulty_var.get())))
...
start_button_MiniMax = tk.Button(window, text="Start Minimax",
                                 command=lambda: start_game_with_minimax(get_depth(difficulty_var.get())))
